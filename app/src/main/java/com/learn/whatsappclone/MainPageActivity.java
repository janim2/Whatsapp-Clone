...
import com.learn.whatsappclone.Chat.ChatListAdapter;
...
//        one signal user dubscription starts here
        ...
        //one signal user subscription ends here

        Button mLogout = findViewById(R.id.signout);
...
//                        mChatListAdapter.notifyDataSetChanged();
    ...
    private void getUserData(UserObject mUser) {
        DatabaseReference mUserDb = FirebaseDatabase.getInstance()
                .getReference().child("user").child(mUser.getUid());
        mUserDb.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.child("notificationKey").getValue() != null)
                    mUser.setNotification_key(dataSnapshot.child("notificationKey").getValue().toString());

                for(ChatObject mChat : chatList){
                    for (UserObject mUserIt : mChat.getUserObjectArrayList()){
                        if(mUserIt.getUid().equals(mUser.getUid())){
                            mUserIt.setNotification_key(mUser.getNotification_key());
                        }
                    }
                }
                mChatListAdapter.notifyDataSetChanged();
