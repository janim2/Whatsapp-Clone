...
import com.learn.whatsappclone.Adapters.MessageAdapter;
import com.learn.whatsappclone.Chat.ChatObject;
import com.learn.whatsappclone.Chat.MediaAdapter;
import com.learn.whatsappclone.Chat.MessageObject;
import com.learn.whatsappclone.Models.UserObject;
import com.learn.whatsappclone.Utils.SendNotification;
...
//        chatID = getIntent().getStringExtra("chatID");
        ...
        mChatMessagesDb = FirebaseDatabase.getInstance().getReference()
                .child("chat").child(mChatObject.getChatId()).child("messages");//.push();//child("messages");
...
//
                    //loading media image from database
    ...
    private void sendMessage(){
        ...
        final DatabaseReference newMessageDb = mChatMessagesDb
                .child(messageId);
        ...
        if(!mediaUriList.isEmpty()){
            for (String mediaUri : mediaUriList){
                ...
                final StorageReference filePath = FirebaseStorage.getInstance()
                        .getReference().child("chat").child(mChatObject.getChatId())
    ...
    private void updateDatabaseWithNewMessage(DatabaseReference newMessageDb, Map newMessageMap){
        ...
        for(UserObject mUser : mChatObject.getUserObjectArrayList()){
            if(!mUser.getUid().equals(FirebaseAuth.getInstance().getUid())){
                new SendNotification(message, "New Message", mUser.getNotification_key());
            }
        }
    }
